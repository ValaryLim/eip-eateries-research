...
# regressions
lm_500m_chinese = lm(Chinese ~ chinese_proportion_05 + malay_proportion_05, data=restaurant_df_500m)
lm_500m_malay = lm(Malay ~ chinese_proportion_05 + malay_proportion_05, data=restaurant_df_500m)
lm_500m_indian = lm(Indian ~ chinese_proportion_05 + malay_proportion_05, data=restaurant_df_500m)
...
stargazer(lm_500m_chinese, lm_500m_malay, lm_500m_indian, 
          ...
          covariate.labels=c("Chinese Ethnic Proportion","Malay Ethnic Proportion"),
          out = "results/regressions_v2/option2_500m_prelim.tex")
...
# regressions
lm_1km_chinese = lm(Chinese ~ chinese_proportion_1 + malay_proportion_1, data=restaurant_df_1km)
lm_1km_malay = lm(Malay ~ chinese_proportion_1 + malay_proportion_1, data=restaurant_df_1km)
lm_1km_indian = lm(Indian ~ chinese_proportion_1 + malay_proportion_1, data=restaurant_df_1km)
...
stargazer(lm_1km_chinese, lm_1km_malay, lm_1km_indian, 
          ...
          dep.var.labels=c("Chinese Cuisine", "Malay Cuisine", "Indian Cuisine"),
          covariate.labels=c("Chinese Ethnic Proportion","Malay Ethnic Proportion"),
          out = "results/regressions_v2/option2_1km_prelim.tex")
...
# regressions
lm_500m_chinese_comp = lm(Chinese ~ chinese_proportion_05 + malay_proportion_05
                          + competition_chinese_proportion_05 + competition_malay_proportion_05, 
                          data=restaurant_df_500m)
lm_500m_malay_comp = lm(Malay ~ chinese_proportion_05 + malay_proportion_05
                        + competition_chinese_proportion_05 + competition_malay_proportion_05, 
                        data=restaurant_df_500m)
lm_500m_indian_comp = lm(Indian ~ chinese_proportion_05 + malay_proportion_05
                         + competition_chinese_proportion_05 + competition_malay_proportion_05,
                         data=restaurant_df_500m)
...
stargazer(lm_500m_chinese_comp, lm_500m_malay_comp, lm_500m_indian_comp, 
          ...
          out = "results/regressions_v2/option2_500m_competition.tex")
...
# regressions
lm_1km_chinese_comp = lm(Chinese ~ chinese_proportion_1 + malay_proportion_1
                         + competition_chinese_proportion_1 + competition_malay_proportion_1, 
                         data=restaurant_df_1km)
lm_1km_malay_comp = lm(Malay ~ chinese_proportion_1 + malay_proportion_1
                       + competition_chinese_proportion_1 + competition_malay_proportion_1, 
                       data=restaurant_df_1km)
lm_1km_indian_comp = lm(Indian ~ chinese_proportion_1 + malay_proportion_1
                        + competition_chinese_proportion_1 + competition_malay_proportion_1,
                        data=restaurant_df_1km)
...
stargazer(lm_1km_chinese_comp, lm_1km_malay_comp, lm_1km_indian_comp, 
          ...
          covariate.labels=c("Chinese Ethnic Proportion","Malay Ethnic Proportion",
                             "Chinese Cuisine Proportion", "Malay Cuisine Proportion"),
          out = "results/regressions_v2/option2_1km_competition.tex")
...
# regressions
lm_500m_chinese_price = lm(Chinese ~ chinese_proportion_05 + malay_proportion_05
                           + competition_chinese_proportion_05 + competition_malay_proportion_05
                           + price_per_pax, data=restaurant_df_500m)
lm_500m_malay_price = lm(Malay ~ chinese_proportion_05 + malay_proportion_05
                         + competition_chinese_proportion_05 + competition_malay_proportion_05
                         + price_per_pax, data=restaurant_df_500m)
lm_500m_indian_price = lm(Indian ~ chinese_proportion_05 + malay_proportion_05
                          + competition_chinese_proportion_05 + competition_malay_proportion_05
                          + price_per_pax, data=restaurant_df_500m)
...
stargazer(lm_500m_chinese_price, lm_500m_malay_price, lm_500m_indian_price, 
          ...
          covariate.labels=c("Chinese Ethnic Proportion","Malay Ethnic Proportion",
                             "Chinese Cuisine Proportion", "Malay Cuisine Proportion",
                             "Price Per Pax"),
          out = "results/regressions_v2/option2_500m_competition_price.tex")
...
# regressions
lm_1km_chinese_price = lm(Chinese ~ chinese_proportion_1 + malay_proportion_1
                          + competition_chinese_proportion_1 + competition_malay_proportion_1
                          + price_per_pax, data=restaurant_df_1km)
lm_1km_malay_price = lm(Malay ~ chinese_proportion_1 + malay_proportion_1
                        + competition_chinese_proportion_1 + competition_malay_proportion_1
                        + price_per_pax, data=restaurant_df_1km)
lm_1km_indian_price = lm(Indian ~ chinese_proportion_1 + malay_proportion_1
                         + competition_chinese_proportion_1 + competition_malay_proportion_1
                         + price_per_pax, data=restaurant_df_1km)
...
stargazer(lm_1km_chinese_price, lm_1km_malay_price, lm_1km_indian_price, 
          ...
          covariate.labels=c("Chinese Ethnic Proportion","Malay Ethnic Proportion",
                             "Chinese Cuisine Proportion", "Malay Cuisine Proportion",
                             "Price Per Pax"),
          out = "results/regressions_v2/option2_1km_competition_price.tex")
...
stargazer(lm_500m_chinese, lm_500m_malay, lm_500m_indian,
          ...
          covariate.labels=c("Chinese Ethnic Proportion","Malay Ethnic Proportion",
                             "Chinese Cuisine Proportion", "Malay Cuisine Proportion",
                             "Price Per Pax"),
          out = "results/regressions_v2/option2_500m_collated.tex")
...
stargazer(lm_1km_chinese, lm_1km_malay, lm_1km_indian,
          ...
          covariate.labels=c("Chinese Ethnic Proportion","Malay Ethnic Proportion", 
                             "Chinese Cuisine Proportion", "Malay Cuisine Proportion", 
                             "Price Per Pax"),
          out = "results/regressions_v2/option2_1km_collated.tex")
