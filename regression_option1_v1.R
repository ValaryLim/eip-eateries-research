...
# regressions
lm_500m_chinese = lm(Chinese ~ chi_quota_05 + malay_quota_05 + io_quota_05 + chinese_proportion_05 + malay_proportion_05 + indian_other_proportion_05, data=restaurant_df_500m)
lm_500m_malay = lm(Malay ~ chi_quota_05 + malay_quota_05 + io_quota_05 + chinese_proportion_05 + malay_proportion_05 + indian_other_proportion_05, data=restaurant_df_500m)
lm_500m_indian = lm(Indian ~ chi_quota_05 + malay_quota_05 + io_quota_05 + chinese_proportion_05 + malay_proportion_05 + indian_other_proportion_05,data=restaurant_df_500m)
...
stargazer(lm_500m_chinese, lm_500m_malay, lm_500m_indian, 
          ...
          covariate.labels=c(
            ...
            "Chinese Ethnic Proportion","Malay Ethnic Proportion", "Indian/Others Ethnic Proportion"),
          out = "results/regressions_v1/option1_500m_prelim.tex")
...
# regressions
lm_1km_chinese = lm(Chinese ~ chi_quota_1 + malay_quota_1 + io_quota_1 + chinese_proportion_1 + malay_proportion_1 + indian_other_proportion_1, data=restaurant_df_1km)
lm_1km_malay = lm(Malay ~ chi_quota_1 + malay_quota_1 + io_quota_1 + chinese_proportion_1 + malay_proportion_1 + indian_other_proportion_1, data=restaurant_df_1km)
lm_1km_indian = lm(Indian ~ chi_quota_1 + malay_quota_1 + io_quota_1 + chinese_proportion_1 + malay_proportion_1 + indian_other_proportion_1,data=restaurant_df_1km)
...
stargazer(lm_1km_chinese, lm_1km_malay, lm_1km_indian, 
          ...
          covariate.labels=c(
            "Chinese Quota", "Malay Quota", "Indian/Others Quota",
            "Chinese Ethnic Proportion","Malay Ethnic Proportion", "Indian/Others Ethnic Proportion"),
          out = "results/regressions_v1/option1_1km_prelim.tex")
...
lm_500m_chinese_comp = lm(Chinese ~ chi_quota_05 + malay_quota_05 + io_quota_05 + chinese_proportion_05 
                          ...
                          + competition_indian_proportion_05, data=restaurant_df_500m)
...
stargazer(lm_500m_chinese_comp, lm_500m_malay_comp, lm_500m_indian_comp, 
          ...
          out = "results/regressions_v1/option1_500m_competition.tex")
...
lm_1km_chinese_comp = lm(Chinese ~ chi_quota_1 + malay_quota_1 + io_quota_1 + chinese_proportion_1 
                         ...
                         + competition_indian_proportion_1, data=restaurant_df_1km)
...
stargazer(lm_1km_chinese_comp, lm_1km_malay_comp, lm_1km_indian_comp, 
          ...
          covariate.labels=c(
            ...
            "Chinese Ethnic Proportion","Malay Ethnic Proportion", "Indian/Others Ethnic Proportion",
            "Chinese Cuisine Proportion", "Malay Cuisine Proportion", "Indian Cuisine Proportion"),
          out = "results/regressions_v1/option1_1km_competition.tex")
...
lm_500m_chinese_price = lm(Chinese ~ chi_quota_05 + malay_quota_05 + io_quota_05 + chinese_proportion_05 
                           + malay_proportion_05 + indian_other_proportion_05
                           + competition_chinese_proportion_05 + competition_malay_proportion_05
                           + competition_indian_proportion_05 + price_per_pax, data=restaurant_df_500m)
...
stargazer(lm_500m_chinese_price, lm_500m_malay_price, lm_500m_indian_price, 
          ...
          covariate.labels=c(
            ...
            "Chinese Cuisine Proportion", "Malay Cuisine Proportion", "Indian Cuisine Proportion", 
            "Price Per Pax"),
          out = "results/regressions_v1/option1_500m_competition_price.tex")
...
lm_1km_chinese_price = lm(Chinese ~ chi_quota_1 + malay_quota_1 + io_quota_1 + chinese_proportion_1 
                          + malay_proportion_1 + indian_other_proportion_1
                          + competition_chinese_proportion_1 + competition_malay_proportion_1
                          + competition_indian_proportion_1 + price_per_pax, data=restaurant_df_1km)
...
stargazer(lm_1km_chinese_price, lm_1km_malay_price, lm_1km_indian_price, 
          ...
          covariate.labels=c(
            ...
            "Chinese Cuisine Proportion", "Malay Cuisine Proportion", "Indian Cuisine Proportion", 
            "Price Per Pax"),
          out = "results/regressions_v1/option1_1km_competition_price.tex")
...
stargazer(lm_500m_chinese, lm_500m_malay, lm_500m_indian,
          ...
          covariate.labels=c("Chinese Quota", "Malay Quota", "Indian/Others Quota",
                             ...
                             "Chinese Cuisine Proportion", "Malay Cuisine Proportion", "Indian Cuisine Proportion",
                             "Price Per Pax"),
          out = "results/regressions_v1/option1_500m_collated.tex")
...
stargazer(lm_1km_chinese, lm_1km_malay, lm_1km_indian,
          ...
          covariate.labels=c("Chinese Quota", "Malay Quota", "Indian/Others Quota",
                             ...
                             "Chinese Cuisine Proportion", "Malay Cuisine Proportion", "Indian Cuisine Proportion",
                             "Price Per Pax"),
          out = "results/regressions_v1/option1_1km_collated.tex")
